...
function addItemToToDoList(todo){
  todos.push(todo)
}
...
let OrderedListItems = document.querySelectorAll('li')
...
orderedList.appendChild(addedListItem)
}
